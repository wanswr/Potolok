...
export const Hero = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // =========================
      // Background light (safe ref)
      // =========================
      const heroLight =
        bgWrapperRef.current.querySelector<HTMLElement>('.hero-light');
      ...
      >
        <div className="max-w-4xl">
          <div className="inline-block px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-12 overflow-hidden">
            <span className="text-sm font-bold tracking-[0.2em] uppercase text-white/80">
              Premium Quality
            </span>
          </div>
