...
const STEPS = [
  {
    id: "measure",
    title: "Точный замер",
    description: "Лазерное сканирование пространства для идеального прилегания профиля без зазоров.",
  },
  {
    id: "design",
    title: "Архитектурный проект",
    description: "Разработка узлов примыкания и световых решений в 3D. Видите результат до начала работ.",
  },
  {
    id: "install",
    title: "Чистый монтаж",
    description: "Используем строительные пылесосы и безопасное оборудование. Никакой пыли на стенах.",
  },
  {
    id: "result",
    title: "Безупречный финал",
    description: "Гарантия на монтаж и материалы. Пожизненная сервисная поддержка вашего потолка.",
  }
];
